...
Adjoint Transformation, but questionable applicability. 


\section{Manipulator Kinematics}

\subsection{Forward Kinematics}
Products of exponential formula
1. Uniform treatment of revolute and prismatic joints
2. Only two reference frame (base and tool)
3. Easy geometric intepretation
