...
Decided to not cover this at the moment, but for interested look up
\emph{Adjoint Transformation}

\textbf{Edit:} we actually have to cover this because:
\begin{enumerate}
  \item Adjoint transformation is needed for showing product of exponential.
  \item Body vs Spatial velocity is needed for showing manipulator jacobian.
\end{enumerate}
...
\paragraph{A more generalized approach}
product of exponential equations should go here, but it requires a adjoint transformation.
